...
from gnova.task.sequence_generation_inference_utils import GenerationInference
from utils.data.BasicClass import Residual_seq


def sequence_generation_inference(cfg: DictConfig, spec_header, test_dl, model, device):
