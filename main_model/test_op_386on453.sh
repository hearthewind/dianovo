...
wandb.project=RNova-Astral wandb.name=op-46453 \
infer.optimal_path_file=prediction/optimal_path/386on453.csv \
infer.dataset_dir=~/data/Dropbox/shared/dianovo_data/processed_data_46386/ \
infer.test_spec_header_filename=02052023_Yeast_KO_3Th_2p5ms_KO1_rep01_20230503212731_1.csv
