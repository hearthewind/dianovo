...
mode=train device=gpu task=optimal_path serialized_model_path=save/ckpt \
...
sample=a100_80g_light wandb.project=GNova-Multi-DIA wandb.name=OptimalPath-pain19777