...
python -u main.py mode=train device=gpu task=peak_classification serialized_model_path=save/ckpt \
...
sample=4090_24g_light wandb.project=GNova-Astral wandb.name=peak-46453 \
train.detect_period=400 train.eval_period=4000
