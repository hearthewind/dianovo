...
def knapsack_build(mass_max, aa_resolution):
    ...
    np.save("../../save/knapsack/knapsack.npy", knapsack_matrix)
...
def knapsack_mask(tgt, knapsack_matrix, remaining_mass, mass_precision_tolerance, aa_resolution, aa_dict):
    single_aa_candidate = knapsack_search(knapsack_matrix, remaining_mass, mass_precision_tolerance, aa_resolution, aa_dict)
    single_aa_candidate = list(set(single_aa_candidate))
...
def knapsack_mask_x2(tgt, knapsack_matrix, peptide_mass1, peptide_mass2, mass_precision_tolerance, aa_resolution, aa_dict):
